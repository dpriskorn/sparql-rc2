      ...
      <Container className="mt-5">
        <Card className="shadow-sm">
          <Card.Body>
            ...
            <p>
              We are looking for passionate contributors to help maintain and
              improve Wikidata Topic Curator. As a co-maintainer, you will have
              the opportunity to shape the project, fix issues, and add new
              features.
            </p>
